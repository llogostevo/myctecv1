CREATE TABLE `myCTECv1`.`centre` (
  ...
  CREATE TABLE `myCTECv1`.`centreCourses` (
	...
	FOREIGN KEY (`centreNumber`) REFERENCES `myCTECv1`.`centre`(`centreNumber`),
...
CREATE TABLE `myCTECv1`.`learningOutcomeCriteria` (
  ...
  FOREIGN KEY (`learningOutcomeID`) REFERENCES `myCTECv1`.`learningOutcomes`(`learningOutcomeID`));
...
CREATE TABLE `myCTECv1`.`unitAssessment` (
  ...
  FOREIGN KEY (`loCriteriaID`) REFERENCES `myCTECv1`.`learningOutcomeCriteria`(`loCriteriaID`)
  );
